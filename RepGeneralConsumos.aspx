<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepGeneralConsumos.aspx.cs" Inherits="FESAJustificacion.RepGeneralConsumos" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%">
                            ...
                            <LocalReport DisplayName="Reporte de consumos" EnableExternalImages="True" ReportPath="Reporte/rp_generalConsumo.rdlc">
                            </LocalReport>
